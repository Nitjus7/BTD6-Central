...
function swapToDegreeCalculator() {
    ...
    document.querySelector(".helpButton").onclick = () => {
        let popupHTML = `
        <h3 class="popupInnerHeader">Tiers</h3>
        <p class="popupInnerContent">
            ...
            <b>DO NOT include the original three Tier 5s</b>.
        </p>
        <h3 class="popupInnerHeader">Total Pops</h3>
        <p class="popupInnerContent">
            Add up all the pop counts on the same tower type as the Paragon. <b>Multiply cash generated by 4, then add it 
            to the pop count.</b>
        </p>
        <h3 class="popupInnerHeader">Extra Tier 5s</h3>
        <p class="popupInnerContent">
            Add up every Tier 5 on that tower type. <b>DO NOT include the original three Tier 5s.</b>
        </p>
        <h3 class="popupInnerHeader">Cash in Sacrifices</h3>
        <p class="popupInnerContent">
            The total amount of cash spent in towers that will be sacrificed to the Paragon when purchased. <b>DO NOT include the cheapest three Tier 5s.</b>
        </p>
        <h3 class="popupInnerHeader">Cash Slider</h3>
        <p class="popupInnerContent">
            The cash slider right before a Paragon upgrade. This combines with your cash in sacrifices.
        </p>
        <h3 class="popupInnerHeader">Paragon Totems</h3>
        <p class="popupInnerContent">
